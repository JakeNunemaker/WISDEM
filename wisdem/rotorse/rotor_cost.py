...
class virtual_factory(object):
    ...
    def execute_fixed_cost(self, operation, ct, blade_variable_cost_w_overhead):
        ...
        working_annuity                         = npf.pmt(self.crr /100. / 12. , self.wcp, -(self.wcp / 12. * (total_maintenance_labor_cost_per_year + blade_variable_cost_w_overhead * self.n_blades))) * 12.
...
def compute_cost_annuity(self, operation, investment, life, verbosity):
        ...
        annuity         = npf.pmt(self.crr / 100. / 12., life * 12., -investment) * 12.
